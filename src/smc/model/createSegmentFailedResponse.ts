...
export class CreateSegmentFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateSegmentFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateSegmentFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateSegmentFailedResponse.attributeTypeMap;
    }
}

export namespace CreateSegmentFailedResponse {
