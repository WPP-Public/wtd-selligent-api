...
export class CreateMobileMessageContentSuccessResponse {
    'resultCode'?: CreateMobileMessageContentSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateMobileMessageContentSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateMobileMessageContentSuccessResponse.attributeTypeMap;
    }
}

export namespace CreateMobileMessageContentSuccessResponse {
