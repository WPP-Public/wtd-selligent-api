...
export class DeleteDataImportSuccessResponse {
    'resultCode'?: DeleteDataImportSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteDataImportSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteDataImportSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteDataImportSuccessResponse {
