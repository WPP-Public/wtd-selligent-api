...
export class DeleteNotificationGroupFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteNotificationGroupFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteNotificationGroupFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteNotificationGroupFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteNotificationGroupFailedResponse {
