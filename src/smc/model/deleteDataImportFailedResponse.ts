...
export class DeleteDataImportFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteDataImportFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteDataImportFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteDataImportFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteDataImportFailedResponse {
