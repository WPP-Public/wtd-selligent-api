...
export class DeleteListSuccessResponse {
    'resultCode'?: DeleteListSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteListSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteListSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteListSuccessResponse {
