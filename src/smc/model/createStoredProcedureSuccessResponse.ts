...
export class CreateStoredProcedureSuccessResponse {
    'resultCode'?: CreateStoredProcedureSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateStoredProcedureSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateStoredProcedureSuccessResponse.attributeTypeMap;
    }
}

export namespace CreateStoredProcedureSuccessResponse {
