...
export class DeleteTaskSuccessResponse {
    'resultCode'?: DeleteTaskSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteTaskSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteTaskSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteTaskSuccessResponse {
