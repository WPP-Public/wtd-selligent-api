...
export class CreateNotificationGroupFailedExampleResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateNotificationGroupFailedExampleResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateNotificationGroupFailedExampleResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateNotificationGroupFailedExampleResponse.attributeTypeMap;
    }
}

export namespace CreateNotificationGroupFailedExampleResponse {
