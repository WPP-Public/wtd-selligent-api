...
export class CreateDictionarySuccessResponse {
    'resultCode'?: CreateDictionarySuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateDictionarySuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateDictionarySuccessResponse.attributeTypeMap;
    }
}

export namespace CreateDictionarySuccessResponse {
