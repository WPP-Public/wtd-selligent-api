...
export class CreateLabelFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateLabelFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateLabelFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateLabelFailedResponse.attributeTypeMap;
    }
}

export namespace CreateLabelFailedResponse {
