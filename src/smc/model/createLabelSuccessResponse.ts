...
export class CreateLabelSuccessResponse {
    'resultCode'?: CreateLabelSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateLabelSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateLabelSuccessResponse.attributeTypeMap;
    }
}

export namespace CreateLabelSuccessResponse {
