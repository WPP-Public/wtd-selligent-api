...
export class CreateNotificationGroupSuccessExampleResponse {
    'resultCode'?: CreateNotificationGroupSuccessExampleResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateNotificationGroupSuccessExampleResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateNotificationGroupSuccessExampleResponse.attributeTypeMap;
    }
}

export namespace CreateNotificationGroupSuccessExampleResponse {
