...
export class CreateMediumFailedExampleResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateMediumFailedExampleResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateMediumFailedExampleResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateMediumFailedExampleResponse.attributeTypeMap;
    }
}

export namespace CreateMediumFailedExampleResponse {
