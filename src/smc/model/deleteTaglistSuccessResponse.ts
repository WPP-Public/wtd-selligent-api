...
export class DeleteTaglistSuccessResponse {
    'resultCode'?: DeleteTaglistSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteTaglistSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteTaglistSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteTaglistSuccessResponse {
