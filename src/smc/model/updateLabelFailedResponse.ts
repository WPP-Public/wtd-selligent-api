...
export class UpdateLabelFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: UpdateLabelFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "UpdateLabelFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateLabelFailedResponse.attributeTypeMap;
    }
}

export namespace UpdateLabelFailedResponse {
