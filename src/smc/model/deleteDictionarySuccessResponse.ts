...
export class DeleteDictionarySuccessResponse {
    'resultCode'?: DeleteDictionarySuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteDictionarySuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteDictionarySuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteDictionarySuccessResponse {
