...
export class DeleteListFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteListFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteListFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteListFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteListFailedResponse {
