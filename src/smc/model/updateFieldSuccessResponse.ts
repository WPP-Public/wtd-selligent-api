...
export class UpdateFieldSuccessResponse {
    /**
    * ResultCode
    */
    'resultCode'?: UpdateFieldSuccessResponse.ResultCodeEnum;
    /**
    * Message
    */
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "UpdateFieldSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateFieldSuccessResponse.attributeTypeMap;
    }
}

export namespace UpdateFieldSuccessResponse {
