...
export class CreateListFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateListFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateListFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateListFailedResponse.attributeTypeMap;
    }
}

export namespace CreateListFailedResponse {
