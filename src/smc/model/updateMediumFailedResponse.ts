...
export class UpdateMediumFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: UpdateMediumFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "UpdateMediumFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateMediumFailedResponse.attributeTypeMap;
    }
}

export namespace UpdateMediumFailedResponse {
