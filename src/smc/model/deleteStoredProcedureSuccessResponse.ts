...
export class DeleteStoredProcedureSuccessResponse {
    'resultCode'?: DeleteStoredProcedureSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteStoredProcedureSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteStoredProcedureSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteStoredProcedureSuccessResponse {
