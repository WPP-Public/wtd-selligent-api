...
export class UpdateDictionaryFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: UpdateDictionaryFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "UpdateDictionaryFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateDictionaryFailedResponse.attributeTypeMap;
    }
}

export namespace UpdateDictionaryFailedResponse {
