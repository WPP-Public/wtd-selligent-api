...
export class CreateCustomEventFieldsFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateCustomEventFieldsFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateCustomEventFieldsFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateCustomEventFieldsFailedResponse.attributeTypeMap;
    }
}

export namespace CreateCustomEventFieldsFailedResponse {
