...
export class UpdateCustomEventFieldSuccessResponse {
    'resultCode'?: UpdateCustomEventFieldSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "UpdateCustomEventFieldSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateCustomEventFieldSuccessResponse.attributeTypeMap;
    }
}

export namespace UpdateCustomEventFieldSuccessResponse {
