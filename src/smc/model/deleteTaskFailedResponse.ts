...
export class DeleteTaskFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteTaskFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteTaskFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteTaskFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteTaskFailedResponse {
