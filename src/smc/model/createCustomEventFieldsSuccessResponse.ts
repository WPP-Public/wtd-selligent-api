...
export class CreateCustomEventFieldsSuccessResponse {
    'resultCode'?: CreateCustomEventFieldsSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateCustomEventFieldsSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateCustomEventFieldsSuccessResponse.attributeTypeMap;
    }
}

export namespace CreateCustomEventFieldsSuccessResponse {
