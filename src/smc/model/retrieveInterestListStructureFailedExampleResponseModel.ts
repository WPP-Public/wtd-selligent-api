...
export class RetrieveInterestListStructureFailedExampleResponseModel {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: RetrieveInterestListStructureFailedExampleResponseModel.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "RetrieveInterestListStructureFailedExampleResponseModel.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return RetrieveInterestListStructureFailedExampleResponseModel.attributeTypeMap;
    }
}

export namespace RetrieveInterestListStructureFailedExampleResponseModel {
