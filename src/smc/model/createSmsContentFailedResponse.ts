...
export class CreateSmsContentFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateSmsContentFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateSmsContentFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateSmsContentFailedResponse.attributeTypeMap;
    }
}

export namespace CreateSmsContentFailedResponse {
