...
export class UpdateStoredProcedureSuccessResponse {
    'resultCode'?: UpdateStoredProcedureSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "UpdateStoredProcedureSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateStoredProcedureSuccessResponse.attributeTypeMap;
    }
}

export namespace UpdateStoredProcedureSuccessResponse {
