...
export class CancelSingleBatchJourneySuccessResponse {
    'resultCode'?: CancelSingleBatchJourneySuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CancelSingleBatchJourneySuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CancelSingleBatchJourneySuccessResponse.attributeTypeMap;
    }
}

export namespace CancelSingleBatchJourneySuccessResponse {
