...
export class ClearStaticSegmentDataFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: ClearStaticSegmentDataFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ClearStaticSegmentDataFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return ClearStaticSegmentDataFailedResponse.attributeTypeMap;
    }
}

export namespace ClearStaticSegmentDataFailedResponse {
