...
export class DeleteSegmentFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteSegmentFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteSegmentFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteSegmentFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteSegmentFailedResponse {
