...
export class DeleteDataExportFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteDataExportFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteDataExportFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteDataExportFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteDataExportFailedResponse {
