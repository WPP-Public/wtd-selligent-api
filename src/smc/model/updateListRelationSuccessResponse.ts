...
export class UpdateListRelationSuccessResponse {
    /**
    * ResultCode
    */
    'resultCode'?: UpdateListRelationSuccessResponse.ResultCodeEnum;
    /**
    * Message
    */
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "UpdateListRelationSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateListRelationSuccessResponse.attributeTypeMap;
    }
}

export namespace UpdateListRelationSuccessResponse {
