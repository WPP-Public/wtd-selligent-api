...
export class CreateTaglistFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateTaglistFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateTaglistFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateTaglistFailedResponse.attributeTypeMap;
    }
}

export namespace CreateTaglistFailedResponse {
