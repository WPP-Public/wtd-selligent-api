...
export class UpdateLabelSuccessResponse {
    'resultCode'?: UpdateLabelSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "UpdateLabelSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateLabelSuccessResponse.attributeTypeMap;
    }
}

export namespace UpdateLabelSuccessResponse {
