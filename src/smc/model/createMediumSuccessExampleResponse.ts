...
export class CreateMediumSuccessExampleResponse {
    'resultCode'?: CreateMediumSuccessExampleResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateMediumSuccessExampleResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateMediumSuccessExampleResponse.attributeTypeMap;
    }
}

export namespace CreateMediumSuccessExampleResponse {
