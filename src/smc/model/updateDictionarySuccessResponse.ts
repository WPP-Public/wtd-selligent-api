...
export class UpdateDictionarySuccessResponse {
    'resultCode'?: UpdateDictionarySuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "UpdateDictionarySuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateDictionarySuccessResponse.attributeTypeMap;
    }
}

export namespace UpdateDictionarySuccessResponse {
