...
export class DeleteListRelationSuccessResponse {
    'resultCode'?: DeleteListRelationSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteListRelationSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteListRelationSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteListRelationSuccessResponse {
