...
export class UpdateNotificationGroupFailedExampleResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: UpdateNotificationGroupFailedExampleResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "UpdateNotificationGroupFailedExampleResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateNotificationGroupFailedExampleResponse.attributeTypeMap;
    }
}

export namespace UpdateNotificationGroupFailedExampleResponse {
