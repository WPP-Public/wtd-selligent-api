...
export class CreateEmailMessageContentSuccessResponse {
    'resultCode'?: CreateEmailMessageContentSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateEmailMessageContentSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateEmailMessageContentSuccessResponse.attributeTypeMap;
    }
}

export namespace CreateEmailMessageContentSuccessResponse {
