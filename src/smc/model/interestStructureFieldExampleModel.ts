...
export class InterestStructureFieldExampleModel {
    /**
    ...
    */
    'dataType'?: InterestStructureFieldExampleModel.DataTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "dataType",
            "baseName": "data_type",
            "type": "InterestStructureFieldExampleModel.DataTypeEnum"
        },
        {
            "name": "length",
            "baseName": "length",
    ...
    static getAttributeTypeMap() {
        return InterestStructureFieldExampleModel.attributeTypeMap;
    }
}

export namespace InterestStructureFieldExampleModel {
