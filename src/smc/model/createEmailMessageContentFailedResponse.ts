...
export class CreateEmailMessageContentFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateEmailMessageContentFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateEmailMessageContentFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateEmailMessageContentFailedResponse.attributeTypeMap;
    }
}

export namespace CreateEmailMessageContentFailedResponse {
