...
export class CreatePageContentFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreatePageContentFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreatePageContentFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreatePageContentFailedResponse.attributeTypeMap;
    }
}

export namespace CreatePageContentFailedResponse {
