...
export class LaunchSingleBatchJourneySuccessResponse {
    'resultCode'?: LaunchSingleBatchJourneySuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "LaunchSingleBatchJourneySuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return LaunchSingleBatchJourneySuccessResponse.attributeTypeMap;
    }
}

export namespace LaunchSingleBatchJourneySuccessResponse {
