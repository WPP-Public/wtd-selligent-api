...
export class CreateTaglistSuccessResponse {
    'resultCode'?: CreateTaglistSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateTaglistSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateTaglistSuccessResponse.attributeTypeMap;
    }
}

export namespace CreateTaglistSuccessResponse {
