...
export class DeleteCustomEventFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteCustomEventFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteCustomEventFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteCustomEventFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteCustomEventFailedResponse {
