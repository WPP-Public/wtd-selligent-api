...
export class CreateCustomEventFailedExampleResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateCustomEventFailedExampleResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateCustomEventFailedExampleResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateCustomEventFailedExampleResponse.attributeTypeMap;
    }
}

export namespace CreateCustomEventFailedExampleResponse {
