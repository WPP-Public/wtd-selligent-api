...
export class RetrieveAllMediumsFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: RetrieveAllMediumsFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "RetrieveAllMediumsFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return RetrieveAllMediumsFailedResponse.attributeTypeMap;
    }
}

export namespace RetrieveAllMediumsFailedResponse {
