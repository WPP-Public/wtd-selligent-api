...
export class DeleteContentSuccessResponse {
    'resultCode'?: DeleteContentSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteContentSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteContentSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteContentSuccessResponse {
