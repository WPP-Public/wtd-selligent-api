...
export class CreateFtpMediumApiRequestModel {
    /**
    * Type of Ftp Medium - FTPS, SFTP, FTPSImplicit
    */
    'ftpType': CreateFtpMediumApiRequestModel.FtpTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "ftpType",
            "baseName": "ftp_type",
            "type": "CreateFtpMediumApiRequestModel.FtpTypeEnum"
        },
        {
            "name": "server",
            "baseName": "server",
    ...
    static getAttributeTypeMap() {
        return CreateFtpMediumApiRequestModel.attributeTypeMap;
    }
}

export namespace CreateFtpMediumApiRequestModel {
