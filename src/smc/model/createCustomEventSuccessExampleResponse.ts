...
export class CreateCustomEventSuccessExampleResponse {
    'resultCode'?: CreateCustomEventSuccessExampleResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateCustomEventSuccessExampleResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateCustomEventSuccessExampleResponse.attributeTypeMap;
    }
}

export namespace CreateCustomEventSuccessExampleResponse {
