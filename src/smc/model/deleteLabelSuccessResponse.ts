...
export class DeleteLabelSuccessResponse {
    'resultCode'?: DeleteLabelSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteLabelSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteLabelSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteLabelSuccessResponse {
