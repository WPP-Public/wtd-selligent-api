...
export class CreateListRelationsSuccessResponse {
    /**
    * Error information
    */
    ...
    * ResultCode
    */
    'resultCode'?: CreateListRelationsSuccessResponse.ResultCodeEnum;
    /**
    * Message
    */
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateListRelationsSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateListRelationsSuccessResponse.attributeTypeMap;
    }
}

export namespace CreateListRelationsSuccessResponse {
