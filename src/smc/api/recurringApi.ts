...
export enum RecurringApiApiKeys {
}
...
export class RecurringApi {
    ...
    public setApiKey(key: RecurringApiApiKeys, value: string) {
        (this.authentications as any)[RecurringApiApiKeys[key]].apiKey = value;
    }
    ...
    /**
     * 
     * @summary Use this endpoint to delete existing recurring journey.
    ...
    public async recurringDelete (apiName: string, organization: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeleteJourneySuccessResponse;  }> {
        ...
        if (apiName === null || apiName === undefined) {
            throw new Error('Required parameter apiName was null or undefined when calling recurringDelete.');
        }

        // verify required parameter 'organization' is not null or undefined
        if (organization === null || organization === undefined) {
            throw new Error('Required parameter organization was null or undefined when calling recurringDelete.');
        }
    ...
    /**
     * 
     * @summary Use this endpoint to check whether recurring journey already exists.
     * @param apiName Parameter represents API name of the recurring journey.
     * @param organization 
     */
    public async recurringGet (apiName: string, organization: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: JourneyDetailsResponseModel;  }> {
        ...
        // verify required parameter 'apiName' is not null or undefined
        if (apiName === null || apiName === undefined) {
            throw new Error('Required parameter apiName was null or undefined when calling recurringGet.');
        }

        // verify required parameter 'organization' is not null or undefined
        if (organization === null || organization === undefined) {
            throw new Error('Required parameter organization was null or undefined when calling recurringGet.');
        }
