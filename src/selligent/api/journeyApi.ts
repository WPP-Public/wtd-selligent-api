...
import { Journeys } from '../model/journeys';
...
export class JourneyApi {
    ...
    public setApiKey(key: JourneyApiApiKeys, value: string) {
        (this.authentications as any)[JourneyApiApiKeys[key]].apiKey = value;
    }
    ...
    public async journeyGet (organization: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: Journeys;  }> {
        ...
        if (organization === null || organization === undefined) {
            throw new Error('Required parameter organization was null or undefined when calling journeyGet.');
        }
            ...
            return new Promise<{ response: http.ClientResponse; body: Journeys;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "Journeys");
