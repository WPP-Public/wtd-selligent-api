...
import { DeleteDataImportFailedResponse } from '../model/deleteDataImportFailedResponse';
import { DeleteDataImportSuccessResponse } from '../model/deleteDataImportSuccessResponse';
...
export enum DataImportApiApiKeys {
}

export class DataImportApi {
    ...
    public setApiKey(key: DataImportApiApiKeys, value: string) {
        (this.authentications as any)[DataImportApiApiKeys[key]].apiKey = value;
    }
    ...
    /**
     * 
     * @summary Use this endpoint to delete a data import.
    ...
    public async dataImportDeleteDataImport (apiName: string, organization: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeleteDataImportSuccessResponse;  }> {
        ...
        if (apiName === null || apiName === undefined) {
            throw new Error('Required parameter apiName was null or undefined when calling dataImportDeleteDataImport.');
        }

        // verify required parameter 'organization' is not null or undefined
        if (organization === null || organization === undefined) {
            throw new Error('Required parameter organization was null or undefined when calling dataImportDeleteDataImport.');
        }
            ...
            return new Promise<{ response: http.IncomingMessage; body: DeleteDataImportSuccessResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "DeleteDataImportSuccessResponse");
