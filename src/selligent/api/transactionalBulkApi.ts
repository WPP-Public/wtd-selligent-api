...
import { SendTransactionalBulkResponse } from '../model/sendTransactionalBulkResponse';
...
export enum TransactionalBulkApiApiKeys {
}

export class TransactionalBulkApi {
    ...
    public setApiKey(key: TransactionalBulkApiApiKeys, value: string) {
        (this.authentications as any)[TransactionalBulkApiApiKeys[key]].apiKey = value;
    }
    ...
    /**
     * 
     * @summary Use this method to trigger a bulk journey in a transactional way
    ...
    public async transactionalBulkSend (apiName: string, organization: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.ClientResponse; body: SendTransactionalBulkResponse;  }> {
        ...
        const produces = ['application/json', 'text/json', 'result_code', 'errors'];
        ...
        if (apiName === null || apiName === undefined) {
            throw new Error('Required parameter apiName was null or undefined when calling transactionalBulkSend.');
        }

        // verify required parameter 'organization' is not null or undefined
        if (organization === null || organization === undefined) {
            throw new Error('Required parameter organization was null or undefined when calling transactionalBulkSend.');
        }
            ...
            return new Promise<{ response: http.ClientResponse; body: SendTransactionalBulkResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "SendTransactionalBulkResponse");
