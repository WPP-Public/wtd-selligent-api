...
export class UpdateMediumSuccessResponse {
    'resultCode'?: UpdateMediumSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "UpdateMediumSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateMediumSuccessResponse.attributeTypeMap;
    }
}

export namespace UpdateMediumSuccessResponse {
