...
export class RetrieveEngagementListStructureFailedExampleResponseModel {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: RetrieveEngagementListStructureFailedExampleResponseModel.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "RetrieveEngagementListStructureFailedExampleResponseModel.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return RetrieveEngagementListStructureFailedExampleResponseModel.attributeTypeMap;
    }
}

export namespace RetrieveEngagementListStructureFailedExampleResponseModel {
