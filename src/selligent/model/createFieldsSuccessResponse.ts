...
export class CreateFieldsSuccessResponse {
    'resultCode'?: CreateFieldsSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateFieldsSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateFieldsSuccessResponse.attributeTypeMap;
    }
}

export namespace CreateFieldsSuccessResponse {
