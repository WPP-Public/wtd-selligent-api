...
export class UpdateCustomEventSuccessExampleResponse {
    'resultCode'?: UpdateCustomEventSuccessExampleResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "UpdateCustomEventSuccessExampleResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateCustomEventSuccessExampleResponse.attributeTypeMap;
    }
}

export namespace UpdateCustomEventSuccessExampleResponse {
