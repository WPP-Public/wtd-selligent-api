...
export class DeleteListRecordSuccessResponse {
    'resultCode'?: DeleteListRecordSuccessResponse.ResultCodeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteListRecordSuccessResponse.ResultCodeEnum"
        }    ];

    static getAttributeTypeMap() {
        return DeleteListRecordSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteListRecordSuccessResponse {
