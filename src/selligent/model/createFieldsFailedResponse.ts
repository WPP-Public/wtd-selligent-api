...
export class CreateFieldsFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateFieldsFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateFieldsFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateFieldsFailedResponse.attributeTypeMap;
    }
}

export namespace CreateFieldsFailedResponse {
