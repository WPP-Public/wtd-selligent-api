...
export class CreateExportTaskSuccessExampleResponse {
    'resultCode'?: CreateExportTaskSuccessExampleResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateExportTaskSuccessExampleResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateExportTaskSuccessExampleResponse.attributeTypeMap;
    }
}

export namespace CreateExportTaskSuccessExampleResponse {
