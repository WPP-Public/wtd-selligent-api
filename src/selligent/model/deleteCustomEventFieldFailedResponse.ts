...
export class DeleteCustomEventFieldFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteCustomEventFieldFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteCustomEventFieldFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteCustomEventFieldFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteCustomEventFieldFailedResponse {
