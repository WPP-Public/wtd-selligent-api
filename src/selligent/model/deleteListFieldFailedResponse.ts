...
export class DeleteListFieldFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteListFieldFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteListFieldFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteListFieldFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteListFieldFailedResponse {
