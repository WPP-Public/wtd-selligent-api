...
export class DeleteMediumSuccessResponse {
    'resultCode'?: DeleteMediumSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteMediumSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteMediumSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteMediumSuccessResponse {
