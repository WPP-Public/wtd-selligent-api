...
export class DeleteLabelFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteLabelFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteLabelFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteLabelFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteLabelFailedResponse {
