...
export class CreateDictionaryFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateDictionaryFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateDictionaryFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateDictionaryFailedResponse.attributeTypeMap;
    }
}

export namespace CreateDictionaryFailedResponse {
