...
export class DeleteListRecordFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteListRecordFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteListRecordFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteListRecordFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteListRecordFailedResponse {
