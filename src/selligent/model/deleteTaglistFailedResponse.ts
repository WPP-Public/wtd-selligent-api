...
export class DeleteTaglistFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteTaglistFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteTaglistFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteTaglistFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteTaglistFailedResponse {
