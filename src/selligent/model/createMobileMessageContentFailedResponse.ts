...
export class CreateMobileMessageContentFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: CreateMobileMessageContentFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreateMobileMessageContentFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateMobileMessageContentFailedResponse.attributeTypeMap;
    }
}

export namespace CreateMobileMessageContentFailedResponse {
