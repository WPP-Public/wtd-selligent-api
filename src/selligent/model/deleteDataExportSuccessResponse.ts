...
export class DeleteDataExportSuccessResponse {
    'resultCode'?: DeleteDataExportSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteDataExportSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteDataExportSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteDataExportSuccessResponse {
