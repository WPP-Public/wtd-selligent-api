...
export class LaunchSingleBatchJourneyFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: LaunchSingleBatchJourneyFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "LaunchSingleBatchJourneyFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return LaunchSingleBatchJourneyFailedResponse.attributeTypeMap;
    }
}

export namespace LaunchSingleBatchJourneyFailedResponse {
