...
import { ApiBatchTaskModel } from './apiBatchTaskModel';
...
export class CreateBatchTaskApiRequestModel {
    'tasks': Array<ApiBatchTaskModel>;
    'name': string;
    'description'?: string;
    'tags'?: Array<string>;
    'apiName': string;
    ...
    static getAttributeTypeMap() {
        return CreateBatchTaskApiRequestModel.attributeTypeMap;
    }
}
