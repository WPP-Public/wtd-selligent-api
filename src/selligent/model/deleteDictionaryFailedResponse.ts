...
export class DeleteDictionaryFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteDictionaryFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteDictionaryFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteDictionaryFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteDictionaryFailedResponse {
