...
export class UpdateCustomEventFailedExampleResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: UpdateCustomEventFailedExampleResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "UpdateCustomEventFailedExampleResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateCustomEventFailedExampleResponse.attributeTypeMap;
    }
}

export namespace UpdateCustomEventFailedExampleResponse {
