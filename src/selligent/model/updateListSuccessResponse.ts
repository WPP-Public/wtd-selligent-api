...
export class UpdateListSuccessResponse {
    'resultCode'?: UpdateListSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "UpdateListSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateListSuccessResponse.attributeTypeMap;
    }
}

export namespace UpdateListSuccessResponse {
