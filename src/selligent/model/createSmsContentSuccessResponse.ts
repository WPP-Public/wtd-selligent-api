...
export class CreateSmsContentSuccessResponse {
    'resultCode'?: CreateSmsContentSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateSmsContentSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateSmsContentSuccessResponse.attributeTypeMap;
    }
}

export namespace CreateSmsContentSuccessResponse {
