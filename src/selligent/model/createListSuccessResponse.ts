...
export class CreateListSuccessResponse {
    'resultCode'?: CreateListSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreateListSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreateListSuccessResponse.attributeTypeMap;
    }
}

export namespace CreateListSuccessResponse {
