...
export class DeleteStoredProcedureFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteStoredProcedureFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteStoredProcedureFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteStoredProcedureFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteStoredProcedureFailedResponse {
