...
export class DeleteCustomEventFieldSuccessResponse {
    'resultCode'?: DeleteCustomEventFieldSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteCustomEventFieldSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteCustomEventFieldSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteCustomEventFieldSuccessResponse {
