...
export class DeleteNotificationGroupSuccessResponse {
    'resultCode'?: DeleteNotificationGroupSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "DeleteNotificationGroupSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteNotificationGroupSuccessResponse.attributeTypeMap;
    }
}

export namespace DeleteNotificationGroupSuccessResponse {
