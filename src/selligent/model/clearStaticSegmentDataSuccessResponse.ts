...
export class ClearStaticSegmentDataSuccessResponse {
    'resultCode'?: ClearStaticSegmentDataSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "ClearStaticSegmentDataSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return ClearStaticSegmentDataSuccessResponse.attributeTypeMap;
    }
}

export namespace ClearStaticSegmentDataSuccessResponse {
