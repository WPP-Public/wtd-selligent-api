...
export class UpdateTaglistFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: UpdateTaglistFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "UpdateTaglistFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateTaglistFailedResponse.attributeTypeMap;
    }
}

export namespace UpdateTaglistFailedResponse {
