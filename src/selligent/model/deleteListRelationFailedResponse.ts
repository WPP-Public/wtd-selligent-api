...
export class DeleteListRelationFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: DeleteListRelationFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "DeleteListRelationFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return DeleteListRelationFailedResponse.attributeTypeMap;
    }
}

export namespace DeleteListRelationFailedResponse {
