...
export class CreatePageContentSuccessResponse {
    'resultCode'?: CreatePageContentSuccessResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "CreatePageContentSuccessResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return CreatePageContentSuccessResponse.attributeTypeMap;
    }
}

export namespace CreatePageContentSuccessResponse {
