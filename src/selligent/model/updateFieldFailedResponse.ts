...
export class UpdateFieldFailedResponse {
    /**
    * Error information
    */
    ...
    * ResultCode
    */
    'resultCode'?: UpdateFieldFailedResponse.ResultCodeEnum;
    /**
    * Message
    */
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "UpdateFieldFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateFieldFailedResponse.attributeTypeMap;
    }
}

export namespace UpdateFieldFailedResponse {
