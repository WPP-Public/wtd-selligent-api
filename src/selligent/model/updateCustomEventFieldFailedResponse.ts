...
export class UpdateCustomEventFieldFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: UpdateCustomEventFieldFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "UpdateCustomEventFieldFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateCustomEventFieldFailedResponse.attributeTypeMap;
    }
}

export namespace UpdateCustomEventFieldFailedResponse {
