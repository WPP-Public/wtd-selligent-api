...
export class UpdateListFailedResponse {
    'errors'?: Array<ErrorModel>;
    'resultCode'?: UpdateListFailedResponse.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "UpdateListFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateListFailedResponse.attributeTypeMap;
    }
}

export namespace UpdateListFailedResponse {
