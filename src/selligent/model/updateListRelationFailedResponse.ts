...
export class UpdateListRelationFailedResponse {
    /**
    * Error information
    */
    ...
    * ResultCode
    */
    'resultCode'?: UpdateListRelationFailedResponse.ResultCodeEnum;
    /**
    * Message
    */
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "UpdateListRelationFailedResponse.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return UpdateListRelationFailedResponse.attributeTypeMap;
    }
}

export namespace UpdateListRelationFailedResponse {
