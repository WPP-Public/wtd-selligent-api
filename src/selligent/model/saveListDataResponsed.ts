...
export class SaveListDataResponsed {
    'resultCode'?: SaveListDataResponsed.ResultCodeEnum;
    'message'?: string;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "SaveListDataResponsed.ResultCodeEnum"
        },
        {
            "name": "message",
            "baseName": "message",
    ...
    static getAttributeTypeMap() {
        return SaveListDataResponsed.attributeTypeMap;
    }
}

export namespace SaveListDataResponsed {
